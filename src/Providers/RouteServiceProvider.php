...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function map(Router $router, ApiRouter $apiRouter)
    {
        ...
        $router->get('returns/search-order', 'ReturnsPortal\\Controllers\\ReturnController@searchOrder');
        $router->get('returns/track-number/{returnNumber}', 'ReturnsPortal\\Controllers\\ReturnController@trackByNumber');
        ...
        $router->get('admin/returns', 'ReturnsPortal\\Controllers\\AdminReturnController@index')
            ->middleware(['ReturnsPortal\\Middleware\\AdminAuthMiddleware']);
        ...
        // REST API routes deaktiviert (Controller fehlen)
    }
}
